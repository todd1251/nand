...
e),e=d({x:450,y:200},e);wires.push({from:m,to:g,input:0});wires.push({from:g,to:p,input:0});wires.push({from:g,to:l,input:0});wires.push({from:f,to:l,input:1});wires.push({from:f,to:q,input:1});wires.push({from:l,to:p,input:1});wires.push({from:l,to:q,input:0});wires.push({from:p,to:e,input:0});wires.push({from:q,to:e,input:1});redrawWires(n)}
