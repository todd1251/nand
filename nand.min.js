...
var e=a.height/4,d=new paper.Path.Line({from:{x:-(b.stroke.width/2),y:e},to:{x:c,y:e},strokeWidth:.6*b.stroke.width,strokeColor:b.stroke.colour}),c=new paper.Path.Line({from:{x:-(b.stroke.width/2),y:a.height-e},to:{x:c,y:a.height-e},strokeWidth:.6*b.stroke.width,strokeColor:b.stroke.colour});return new paper.Group([d,c,g])};function XorViewDecorator(a,b,c){a=new a(b,c);var d=b.width/7;b=a.bounds.height;var g=b/2,e=2.5*c.stroke.width,h=new paper.Path.Arc({from:{x:-e,y:0},through:{x:d-.85*e,y:g},to:{x:-e,y:b}});h.remove();d=new paper.Path.Arc({from:{x:1-e+c.stroke.width/2,y:-c.stroke.width/2},through:{x:d-.85*e+c.stroke.width,y:g},to:{x:1-e+c.stroke.width/2,y:b+c.stroke.width/2},strokeWidth:c.stroke.width,strokeColor:"white",strokeCap:"square"});d.remove();c=new paper.Path({segments:[{x:1-e,y:0},h.segments[0],h.segments[1],
