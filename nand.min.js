...
e.lineTo({x:b.x+l/2,y:b.y});e.lineTo({x:b.x+l/2,y:d.y});e.lineTo({x:d.x,y:d.y});e.crossings=m}}else console.log("no intersections")});c.path=e})}function MetaDragToConnect(a,c){this.element=a;this.appearance=c}MetaDragToConnect.prototype.dragStarted=function(a){this.originalPosition=this.element.position;this.dragPosition=a.point;a.event.metaKey?(this.connecting=!0,a.stopPropagation()):this.connecting=!1};
