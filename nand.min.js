...
new c))].map(function(a){var b=new DimensionsProportionalToWidth(50),c=new AppearanceProportionalToDimensions(b),d=new AppearanceProportionalToDimensions(b);d.stroke.colour="#ccc";d=new a(b,d);d.position={x:g,y:50};g+=1.1*d.bounds.width;dragToCopy(d,a,b,c)});var k=new DimensionsProportionalToWidth(50),h=new AppearanceProportionalToDimensions(k),n=d({x:247,y:154},FanOutView.bind(null,f)),f=d({x:247,y:246},FanOutView.bind(null,f)),m=d({x:299,y:200},FanOutView.bind(null,e)),l=d({x:350,y:150},e),p=d({x:350,
y:250},e),e=d({x:401,y:200},e);wires.push({from:n,output:0,to:l,input:0});wires.push({from:n,output:1,to:m,input:0});wires.push({from:f,output:0,to:m,input:1});wires.push({from:f,output:1,to:p,input:1});wires.push({from:m,output:0,to:l,input:1});wires.push({from:m,output:1,to:p,input:0});wires.push({from:l,output:0,to:e,input:0});wires.push({from:p,output:0,to:e,input:1});redrawWires(h)}
