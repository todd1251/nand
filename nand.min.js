...
AltDragToCopy.prototype.dragStarted=function(a){this.originalPosition=this.element.position;this.dragPosition=a.point;a.event.altKey?(this.copying=!0,this.newElement=this.element.clone(),this.newElement.alignmentCentre=this.element.alignmentCentre,this.newElement.inputs=this.element.inputs.slice(0),this.newElement.input=this.element.input,this.newElement.outputs=this.element.outputs.slice(0),this.newElement.output=this.element.output,this.newElement.position={x:this.originalPosition.x,y:this.originalPosition.y},
