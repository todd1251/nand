...
return new paper.Group([f,d,g])};function XorView(a,b){var d=new GateView(OrView,!1,a,b),c=d.bounds.height,g=2.5*b.stroke.width,f=new paper.Path.Arc({from:{x:-g,y:0},through:{x:d.gateWidth/7-.85*g,y:c/2},to:{x:-g,y:c}});f.remove();var h=(100<d.gateWidth?2:1)-g,c=new paper.Path({segments:[{x:h,y:0},f.segments[0],f.segments[1],{x:h,y:c}],strokeWidth:b.stroke.width,strokeColor:b.stroke.colour}),c=new paper.Group([d,c]);c.gateWidth=d.gateWidth;c.gapWidth=g;return c};
