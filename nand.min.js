...
return b};function InverterView(a){a=a||{};return new paper.Path.Circle({radius:a.radius||12.5,strokeWidth:a.strokeWidth||4,strokeColor:a.strokeColor||"black",fillColor:a.fillColor||"white"})};function render(){paper.project.activeLayer.removeChildren();(new BufferView({width:75})).position={x:100,y:100};(new BufferView({width:125})).position={x:350,y:100};(new NotView({width:75})).position={x:100,y:300};(new NotView({width:125})).position={x:350,y:300};(new AndView({width:75})).position={x:600,y:100};(new AndView({width:125})).position={x:850,y:100};(new NandView({width:75})).position={x:600,y:300};(new NandView({width:125})).position={x:850,y:300};(new OrView({width:75})).position={x:100,
y:500};(new OrView({width:125})).position={x:350,y:500};(new NorView({width:75})).position={x:100,y:700};(new NorView({width:125})).position={x:350,y:700};(new XorView({width:75})).position={x:600,y:500};(new XorView({width:125})).position={x:850,y:500};(new XNorView({width:75})).position={x:600,y:700};(new XNorView({width:125})).position={x:850,y:700}}
