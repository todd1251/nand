...
new b,new a)),d(OrView.bind(null,new XorDecoration,new b)),d(OrView.bind(null,new XorDecoration,new a))],f=c.map(function(a){var b=new DimensionsProportionalToWidth,c=new AppearanceProportionalToDimensions(b);return new a(b,c)}),e=c.map(function(a){var b=new DimensionsProportionalToWidth(150),c=new AppearanceProportionalToDimensions(b);return new a(b,c)}),h=c.map(function(a){var b=new DimensionsProportionalToWidth(50),c=new AppearanceProportionalToDimensions(b);return new a(b,c)}),c=c.map(function(a){var b=
new DimensionsProportionalToWidth(20),c=new AppearanceProportionalToDimensions(b);return new a(b,c)}),l=null,m=null;e.map(function(a){if(null==l||a.bounds.width>l)l=a.bounds.width;if(null==m||a.bounds.height>m)m=a.bounds.height});var g=175,k=100;f.map(function(a){a.position={x:g,y:k};g+=l;g>2.5*l&&(g=175,k+=m+10)});g=825;k=100;e.map(function(a){a.position={x:g,y:k};g+=l+50;g>7.5*l&&(g=825,k+=m+50)});g=100;k=500;h.map(function(a){a.position={x:g,y:k};g+=l/4+50;g>1.75*l&&(g=100,k+=m/4+50)});g=525;k=
100;c.map(function(a){a.position={x:g,y:k};g+=l/4+50;g>4.5*l&&(g=525,k+=m/4+50)})}window.addEventListener("load",function(){var d=document.getElementById("paper");paper.setup(d);paper.view.onFrame=function(a){paper.view.draw()};paper.view.onResize=function(a){render()};render()});function OrView(d,a,b,c){var f=b.gateWidth/7,e=c.createPath();e.moveTo({x:c.stroke.width/2,y:0});e.lineTo({x:b.narrowSegmentWidth,y:0});var h={x:b.gateWidth,y:b.halfHeight};e.arcTo({x:b.narrowSegmentWidth+b.wideSegmentWidth/2,y:b.halfHeight/4},h);e=a.decorate(e,b,c);h.x=e.bounds.width;e.arcTo({x:b.narrowSegmentWidth+b.wideSegmentWidth/2,y:b.height-b.halfHeight/4},{x:b.narrowSegmentWidth,y:b.height});e.lineTo({x:c.stroke.width/2,y:b.height});e.arcTo({x:f,y:b.halfHeight},{x:c.stroke.width/2,y:0});e.closePath();
e=d.decorate(e,b,c);e.alignmentCentre={x:b.gateWidth/2-f/2,y:b.halfHeight};d=b.height/4;e.inputs=[{x:f,y:d},{x:f,y:b.height-d}];e.outputs=[h];return e};function XorDecoration(){}
XorDecoration.prototype.decorate=function(d,a,b){var c=a.gateWidth/7,f=2*b.stroke.width,e=b.createPath();e.strokeCap="square";e.fillColor=null;e.moveTo({x:0,y:0});e.lineTo({x:-f,y:0});e.arcTo({x:c-f,y:a.halfHeight},{x:-f,y:a.height});e.lineTo({x:0,y:a.height});var h=a.halfHeight,h=c/2*(c/2+h*h)/(2*h),h=new paper.Path.Circle({center:{x:.5-h+c+f/2,y:a.halfHeight},radius:c-h});h.strokeColor="red";h.strokeWidth=b.stroke.width;a=new paper.Path.Rectangle({from:{x:-f,y:-1},to:{x:c,y:a.height+1}});a.strokeColor=
"red";a.strokeWidth=b.stroke.width;b=a.subtract(h);b.strokeColor="white";a.remove();h.remove();return new paper.Group([e,b,d])};
