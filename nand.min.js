...
new XorDecoration,new c))].map(function(a){var b=new DimensionsProportionalToWidth(50),c=new AppearanceProportionalToDimensions(b),d=new AppearanceProportionalToDimensions(b);d.stroke.colour="#ccc";d=new a(b,d);d.position={x:g,y:50};g+=1.1*d.bounds.width;dragToCopy(d,a,b,c)});var k=new DimensionsProportionalToWidth(50),h=new AppearanceProportionalToDimensions(k),n=d({x:247,y:153.25},f),f=d({x:247,y:245.25},f),m=d({x:299,y:200},e),l=d({x:350,y:150},e),p=d({x:350,y:250},e),e=d({x:401,y:200},e);connect(n,
