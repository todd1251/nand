...
a.stopPropagation()}};function render(){function a(a){return GateView.bind(null,a)}function b(){}function c(){}function d(a,b){var c=b(h,n);c.position=a;dragHandlerChain(c,[new MetaDragToConnect(c,n),new DragToMove(c,n)]);return c}paper.project.activeLayer.removeChildren();b.prototype.decorate=function(a,b,c){b=2*b.inverterRadius;a.arcBy({x:b,y:0},!1);a.arcBy({x:-b,y:0},!0);a.arcBy({x:b,y:0},!0);a.arcBy({x:-b,y:0},!1);return a};c.prototype.decorate=function(a,b,c){return a};var f=a(BufferView.bind(null,new c));a(BufferView.bind(null,
new b));var e=a(AndView.bind(null,new c));a(AndView.bind(null,new b));var g=a(OrView.bind(null,new XorDecoration,new c));new paper.Path.Rectangle({point:[0,0],size:[paper.view.bounds.width,paper.view.bounds.height],strokeColor:"#ccc"});var k=50;[a(BufferView.bind(null,new c)),a(BufferView.bind(null,new b)),a(AndView.bind(null,new c)),a(AndView.bind(null,new b)),a(OrView.bind(null,new c,new c)),a(OrView.bind(null,new c,new b)),a(OrView.bind(null,new XorDecoration,new c)),a(OrView.bind(null,new XorDecoration,
new b))].map(function(a){var b=new DimensionsProportionalToWidth(50),c=new AppearanceProportionalToDimensions(b),d=new AppearanceProportionalToDimensions(b);d.stroke.colour="#ccc";d=new a(b,d);d.position={x:k,y:50};k+=1.1*d.bounds.width;dragToCopy(d,a,b,c)});var h=new DimensionsProportionalToWidth(50),n=new AppearanceProportionalToDimensions(h),m=d({x:150,y:150},f),f=d({x:150,y:200},f),g=d({x:250,y:175},g),e=d({x:250,y:250},e);wires.push({from:m,to:g,input:0});wires.push({from:m,to:e,input:0});wires.push({from:f,
to:g,input:1});wires.push({from:f,to:e,input:1});redrawWires(n)}window.addEventListener("load",function(){var a=document.getElementById("paper");paper.setup(a);paper.view.onFrame=function(a){paper.view.draw()};paper.view.onResize=function(a){render()};render();dragToPan();stableScrollToZoom(a)});function OrView(a,b,c,d){var f=c.gateWidth/7,e=d.createPath();e.moveTo({x:d.stroke.width/2,y:0});e.lineTo({x:c.narrowSegmentWidth,y:0});var g={x:c.gateWidth,y:c.halfHeight};e.arcTo({x:c.narrowSegmentWidth+c.wideSegmentWidth/2,y:c.halfHeight/4},g);e=b.decorate(e,c,d);g.x=e.bounds.width;e.arcTo({x:c.narrowSegmentWidth+c.wideSegmentWidth/2,y:c.height-c.halfHeight/4},{x:c.narrowSegmentWidth,y:c.height});e.lineTo({x:d.stroke.width/2,y:c.height});e.arcTo({x:f,y:c.halfHeight},{x:d.stroke.width/2,y:0});e.closePath();
