...
function XorViewDecorator(a,b,d){a=new a(b,d);var c=b.width/7;b=a.bounds.height;var g=b/2,e=2.5*d.stroke.width,h=new paper.Path.Arc({from:{x:-e,y:0},through:{x:c-.85*e,y:g},to:{x:-e,y:b}});h.remove();c=new paper.Path.Arc({from:{x:1-e+3*d.stroke.width/4,y:-d.stroke.width/2},through:{x:c-.85*e+d.stroke.width,y:g},to:{x:1-e+3*d.stroke.width/4,y:b+d.stroke.width/2},strokeWidth:d.stroke.width,strokeColor:"white",strokeCap:"square"});c.remove();d=new paper.Path({segments:[{x:1-e,y:0},h.segments[0],h.segments[1],
{x:1-e,y:b}],strokeWidth:d.stroke.width,strokeColor:d.stroke.colour,strokeCap:"square"});return new paper.Group([a,d,c])};function render(){function a(a){return Inverted.bind(null,a)}paper.project.activeLayer.removeChildren();var b=[GateView.bind(null,BufferView,!0),a(GateView.bind(null,BufferView,!0)),GateView.bind(null,AndView,void 0),a(GateView.bind(null,AndView,void 0)),GateView.bind(null,OrView,void 0),a(GateView.bind(null,OrView,void 0)),XorViewDecorator.bind(null,GateView.bind(null,OrView,void 0)),XorViewDecorator.bind(null,a(GateView.bind(null,OrView,void 0)))],d=b.map(function(a){var b=new DimensionsProportionalToWidth,
...
window.addEventListener("load",function(){var a=document.getElementById("paper");paper.setup(a);paper.view.onFrame=function(a){paper.view.draw()};paper.view.onResize=function(a){render()};render()});
