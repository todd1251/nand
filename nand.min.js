...
window.addEventListener("load",function(){var b=document.getElementById("paper");paper.setup(b);paper.view.onFrame=function(a){paper.view.draw()};paper.view.onResize=function(a){render()};render()});function OrView(b,a,c){var d=a.gateWidth/7,g=a.height/2,e=c.createPath();e.moveTo({x:c.stroke.width/2,y:0});e.lineTo({x:a.narrowSegmentWidth,y:0});var f={x:a.gateWidth,y:g};e.arcTo({x:a.narrowSegmentWidth+a.wideSegmentWidth/2,y:g/4},f);b(e,a);f.x=e.bounds.width;e.arcTo({x:a.narrowSegmentWidth+a.wideSegmentWidth/2,y:a.height-g/4},{x:a.narrowSegmentWidth,y:a.height});e.lineTo({x:c.stroke.width/2,y:a.height});e.arcTo({x:d,y:g},{x:c.stroke.width/2,y:0});e.closePath();d=10;e.alignmentCentre={x:a.gateWidth/
