...
DragToMove.prototype.dragFinished=function(a){this.dragPosition=null;redrawWires(this.appearance)};function dragToPan(){function a(a){c=null}var c;paper.view.onMouseDown=function(a){c=a.point};paper.view.onMouseDrag=function(a){a=a.point;paper.view.center=new paper.Point({x:paper.view.center.x-(a.x-c.x),y:paper.view.center.y-(a.y-c.y)})};paper.view.onMouseUp=a;paper.view.onMouseOut=a};function GateView(a,c,b){a=new a(c,b);var d=c.width/2-a.alignmentCentre.x+a.inputs[0].x/2,f=[];f.push(a);c=[{x:c.width-d+a.inputs[0].x,y:a.outputs[0].y}];for(var e=new paper.Path.Line({from:a.outputs[0],to:c[0],strokeWidth:b.wireStrokeWidth,strokeColor:b.stroke.colour}),g=[],k=0;k<a.inputs.length;k++){var h=a.inputs[k];g[k]={x:h.x-d,y:h.y};f.push(new paper.Path.Line({from:g[k],to:{x:h.x,y:h.y},strokeWidth:b.wireStrokeWidth,strokeColor:b.stroke.colour}))}f.push(e);a=new paper.Group(f);a.inputs=g;a.outputs=
...
e/2,y:f});this.path.lineTo({x:d,y:f});a.stopPropagation()}};MetaDragToConnect.prototype.dragFinished=function(a){this.dragPosition=null;null!=this.path&&this.path.remove();if(this.connecting){var c=paper.project.hitTest(a.point);if(null!=c){var b=c.item.input;null==b?b=0:b++;if(b>=c.item.inputs.length)return;c.item.input=b;wires.push({from:this.element,to:c.item,input:b})}redrawWires(this.appearance);a.stopPropagation()}};function render(){function a(a){return GateView.bind(null,a)}function c(){}function b(){}function d(a,b){var c=b(k,h);c.position=a;dragHandlerChain(c,[new MetaDragToConnect(c,h),new DragToMove(c,h)]);return c}paper.project.activeLayer.removeChildren();c.prototype.decorate=function(a,b,c){b=2*b.inverterRadius;a.arcBy({x:b,y:0},!1);a.arcBy({x:-b,y:0},!0);a.arcBy({x:b,y:0},!0);a.arcBy({x:-b,y:0},!1);return a};b.prototype.decorate=function(a,b,c){return a};a(BufferView.bind(null,new b));var f=a(BufferView.bind(null,
new c)),e=a(AndView.bind(null,new b));a(AndView.bind(null,new c));new paper.Path.Rectangle({point:[0,0],size:[paper.view.bounds.width,paper.view.bounds.height],strokeColor:"#ccc"});var g=50;[a(BufferView.bind(null,new b)),a(BufferView.bind(null,new c)),a(AndView.bind(null,new b)),a(AndView.bind(null,new c)),a(OrView.bind(null,new b,new b)),a(OrView.bind(null,new b,new c)),a(OrView.bind(null,new XorDecoration,new b)),a(OrView.bind(null,new XorDecoration,new c))].map(function(a){var b=new DimensionsProportionalToWidth(50),
c=new AppearanceProportionalToDimensions(b),d=new AppearanceProportionalToDimensions(b);d.stroke.colour="#ccc";d=new a(b,d);d.position={x:g,y:50};g+=1.1*d.bounds.width;dragToCopy(d,a,b,c)});var k=new DimensionsProportionalToWidth(50),h=new AppearanceProportionalToDimensions(k),n=d({x:150,y:150},f),f=d({x:150,y:250},f),e=d({x:250,y:200},e);wires.push({from:n,to:e,input:0});wires.push({from:f,to:e,input:1});redrawWires(h)}
