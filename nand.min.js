...
d=c({x:120,y:150},b),g=c({x:150,y:200},b),h=c({x:250,y:146},l),p=c({x:250,y:204},f),d=connect(d,h,k,n),d=connect(d,p,k,n),g=connect(g,h,k,n),g=connect(g,p,k,n),e=c({x:420,y:150},b),b=c({x:450,y:200},b),l=c({x:550,y:146},l),f=c({x:550,y:204},f),e=connect(e,l,k,n),e=connect(e,f,k,n),b=connect(b,l,k,n),b=connect(b,f,k,n),d=new CircuitView([d,g,h,p],k,n),f=new CircuitView([e,b,l,f],k,n);connect(d,f,k,n);new CircuitView([d,f],k,n)}
