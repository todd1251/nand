										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Basics$toString(_p1._5),
														_1: {
															ctor: '::',
															_0: _elm_lang$core$Basics$toString(_p1._6),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _user$project$Main$attributes = function (appearance) {
	return {
		ctor: '::',
		_0: _user$project$Main$Stroke(appearance.strokeColour),
		_1: {
			ctor: '::',
...
var _user$project$Main$LineBy = F2(
	function (a, b) {
...
var _user$project$Main$MoveBy = F2(
	function (a, b) {
		return {ctor: 'MoveBy', _0: a, _1: b};
	});
...
var _user$project$Main$transformation = F2(
	function (shape, transform) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$Transform(transform),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Main$path = F2(
	function (description, attributes) {
		return A2(_user$project$Main$Path, description, attributes);
	});
...
var _user$project$Main$and8 = F2(
	function (dimensions, appearance) {
		return A5(_user$project$Main$gate, dimensions, appearance, _user$project$Main$flatBase, _user$project$Main$wideBody, _user$project$Main$roundTip);
	});
var _user$project$Main$or8 = F2(
	function (dimensions, appearance) {
		return A5(_user$project$Main$gate, dimensions, appearance, _user$project$Main$curvedBase, _user$project$Main$narrowBody, _user$project$Main$spearTip);
	});
var _user$project$Main$xor8 = F2(
	function (dimensions, appearance) {
		var gate = A2(_user$project$Main$or8, dimensions, appearance);
		return {
			width: gate.width,
			height: gate.height,
			shape: function () {
...
var _user$project$Main$view = function (model) {
	...
	var wireAttributes = {
		ctor: '::',
		_0: _user$project$Main$StrokeWidth(wireStrokeWidth),
		_1: {
			ctor: '::',
			_0: _user$project$Main$Stroke(strokeColour),
			_1: {
				ctor: '::',
				_0: _user$project$Main$Fill(fillColour),
				_1: {ctor: '[]'}
			}
		}
	};
	...
	var attributes = {
		ctor: '::',
		_0: _user$project$Main$StrokeWidth(strokeWidth),
		_1: {
			ctor: '::',
			_0: _user$project$Main$Stroke(strokeColour),
			_1: {
	...
	var transparentAttributes = {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$Fill('none'),
				_1: {ctor: '[]'}
			}
		}
	};
	...
	var doubleInput = function (x) {
		return A2(
			...
			{
				ctor: '::',
				_0: A5(_user$project$Main$Line, 0 - wireWidth, quarterHeight, x, quarterHeight, wireAttributes),
				_1: {
					ctor: '::',
					_0: A5(_user$project$Main$Line, 0 - wireWidth, threeQuarterHeight, x, threeQuarterHeight, wireAttributes),
					_1: {ctor: '[]'}
				}
			});
	};
	...
	var buffer = A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$Main$MoveTo, bufferOffset, 0),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$LineTo, bufferOffset + wideSegmentWidth, halfHeight),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$LineTo, bufferOffset, height),
							_1: {
								ctor: '::',
								_0: _user$project$Main$Close,
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				ctor: '::',
				_0: singleInput(bufferOffset),
				_1: {
					ctor: '::',
					_0: singleOutput((bufferOffset + narrowSegmentWidth) + wireWidth),
					_1: {ctor: '[]'}
				}
			}
		});
	var inverter = A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: inverterDecoration(bufferOffset + wideSegmentWidth),
				_1: {ctor: '[]'}
			}
		});
	var and = A2(
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Main$MoveTo, 0, 0),
							_1: {
								ctor: '::',
								_0: _user$project$Main$HorizontalLineTo(wideSegmentWidth),
								_1: {
									ctor: '::',
									_0: A7(_user$project$Main$ArcTo, narrowSegmentWidth, narrowSegmentWidth, 0, false, true, gateWidth, halfHeight),
									_1: {
										ctor: '::',
										_0: A7(_user$project$Main$ArcTo, narrowSegmentWidth, narrowSegmentWidth, 0, false, true, wideSegmentWidth, height),
										_1: {
											ctor: '::',
											_0: _user$project$Main$HorizontalLineTo(0),
											_1: {
												ctor: '::',
												_0: _user$project$Main$Close,
												_1: {ctor: '[]'}
	...
	var nand = A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: inverterDecoration(gateWidth),
				_1: {ctor: '[]'}
			}
		});
	var or = A2(
				...
				_1: {
					...
					_0: A2(
						_user$project$Main$Path,
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$Main$HorizontalLineTo(narrowSegmentWidth),
								_1: {
									ctor: '::',
									_0: A7(_user$project$Main$ArcTo, wideSegmentWidth, wideSegmentWidth, 0, false, true, gateWidth, halfHeight),
									_1: {
										ctor: '::',
										_0: A7(_user$project$Main$ArcTo, wideSegmentWidth, wideSegmentWidth, 0, false, true, narrowSegmentWidth, height),
										_1: {
											ctor: '::',
											_0: _user$project$Main$HorizontalLineTo(0),
											_1: {
												ctor: '::',
												_0: A7(_user$project$Main$ArcTo, indentWidth * 6, height, 0, false, false, 0, 0),
												_1: {
													ctor: '::',
													_0: _user$project$Main$Close,
													_1: {ctor: '[]'}
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Main$MoveTo, left, 0),
						_1: {
							ctor: '::',
							_0: A7(_user$project$Main$ArcTo, indentWidth * 6.5, height, 0, false, true, left, height),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$LineTo, left + hack, height),
								_1: {
									ctor: '::',
									_0: A7(_user$project$Main$ArcTo, indentWidth * 6.5, height, 0, false, false, left, 0),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Main$LineTo, left + hack, 0),
										_1: {
											ctor: '::',
											_0: A7(_user$project$Main$ArcTo, indentWidth * 6.5, height, 0, false, true, left, height),
											_1: {ctor: '[]'}
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$fromShape(
							A2(
								_user$project$Main$Group,
								{
									ctor: '::',
								...
								{
									ctor: '::',
									_0: A3(gate, 1, 1, buffer),
									_1: {
										ctor: '::',
										_0: A3(gate, 2, 1, inverter),
										_1: {
											ctor: '::',
											_0: A3(gate, 1, 2, and),
											_1: {
